...
![Figure 5.1 inner and outer spheres of attraction in coordination compounds](image.png)
...
>
>(i)\( \mathrm{K_2[Fe(CN)_3(Cl)_2(NH_3)]} \)
>
>(ii)\( [\mathrm{Cr(CN)_2(H_2O)_4}][\mathrm{Co(ox)_2(en)}] \)
>
>(iii)\( [\mathrm{Cu(NH_3)_2Cl_2}] \)
>
>(iv)\( [\mathrm{Cr(NH_3)_3(NC)_2(H_2O)}]^+ \)
>
>(v)\( [\mathrm{Fe(CN)_6}]^{4-} \)
>
...
![Figure 5.2 Isomerism in coordination compounds](image-2.png)
...
1. \( [\mathrm{Cr(NH_3)_4ClBr}]NO_2 \) and \( [\mathrm{Cr(NH_3)_4Cl NO_2}]Br \)
2. \( [\mathrm{Co(NH_3)_4Br_2}]Cl \) and \( [\mathrm{Co(NH_3)_4Cl Br}]Br \)
...
![Figure 5.6 (a) Facial isomer   Figure 5.6 (b) Meridional isomer](image-5.png)
...
![Figure 5.8 - Optical isomers](image-7.png)
...
![Figure: 5.10 - Crystal field splitting in octahedral field](aaa.png)
...
![Figure 5.11 tetrahedral ligand field](image-10.png)
...
![Figure 5.12 d-orbitals in tetrahedral ligand field](img5.12.png)



![Figure: 5.13 - Crystal field splitting in tetrahedral field](img5.13.png)
...
$$
\mathrm{CFSE}(\Delta \mathrm{E}_{\mathrm{o}}) = \{\mathrm{E}_{\mathrm{LF}}\} -\{\mathrm{E}_{\mathrm{iso}}\}
$$

$$
\qquad = \{\mathrm{[n}_{\mathrm{t_{2g}}}(\mathrm{-0.4}) + \mathrm{n}_{\mathrm{e_{g}}}(0.6)]\Delta_{\mathrm{o}} + \mathrm{n}_{\mathrm{p}}\mathrm{P}\} -\{\mathrm{n}_{\mathrm{p}}^{\prime}\mathrm{P}\}
$$
...
![Figure 5.16 d-d Transition](image-11.png)
...
$$ \left[ \text{Ni(CO)}_4 \right], \left[ \text{Fe(CO)}_5 \right] \text{ and } \left[ \text{Cr(CO)}_6 \right] $$
![](metal1.png)
...
#### 5.7.1 Stepwise formation constants and overall formation constants
...
### 5.8 Importance and applications of coordination complexes
