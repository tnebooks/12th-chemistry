...
![Martin Heinrich Klaproth, (1743- 1817)](Martin.png)
...
![Figure 4.2 lattice structures of 3d, 4d and 5d transition metals](image-1.png)
...
![Figure 4.3-Variation in melting point of 3d series elements](image-2.png)
...
![Figure 4.4 (b) Atomic radius of 4d Elements](image-4.png)

![Figure 4.4 (c) Atomic radius of 5d Elements](image-5.png)
...
![Figure 4.5 Variation in ionisation energy of 3d series elements](image-6.png)
...
>**Evaluate yourself:**
>
>Compare the stability of $\text{Ni}^{4+}$ and $\text{Pt}^{4+}$ from their ionisation enthalpy values.
>
>| IE | Ni | Pt |
| --- | --- | --- |
| **I** | 737 | 864 |
...
![Figure 4.6 Frost diagram](image-7.png)
...
![Figure 4.7(b) \((E_{M^{3+}/M^{2+}}^{0})\) -3d series](image-9.png)
...
$$\underset{\begin{array}{c} \text{sodium chromate} \\ \text{(yellow)} \end{array}}{\text{2Na}_2\text{CrO}_4} + \text{H}_2\text{SO}_4 \longrightarrow \underset{\begin{array}{c} \text{sodium dichromate} \\ \text{(orange red)} \end{array}}{\text{Na}_2\text{Cr}_2\text{O}_7} + \text{Na}_2\text{SO}_4 + \text{H}_2\text{O}$$
...
$$\underset{\begin{array}{c} \text{sodium dichromate} \\ \text{(orange red)} \end{array}}{\text{Na}_2\text{Cr}_2\text{O}_7} + 2\text{KCl} \longrightarrow \underset{\begin{array}{c} \text{potassium dichromate} \\ \text{(orange red)} \end{array}}{\text{K}_2\text{Cr}_2\text{O}_7} + 2\text{NaCl}$$
...
$$ \underset{\begin{array}{c} \text{potassium} \\ \text{dichromate} \end{array}}{\text{4K}_2\text{Cr}_2\text{O}_7} \xrightarrow{\quad \Delta \quad}  \underset{\begin{array}{c} \text{potassium} \\ \text{chromate} \end{array}}{\text{4K}_2\text{CrO}_4} +  \underset{\begin{array}{c} \text{chromium(III)} \\ \text{oxide} \end{array}}{\text{2Cr}_2\text{O}_3} + 3\text{O}_2\uparrow$$

## Structure of dichromate ion:

![Figure 4.8 (a) Structure of  
chromate ion](image-10.png)


![Figure 4.8 (b) Structure of 
dichromate ion](image-11.png)
...
$$\text{K}_2\text{Cr}_2\text{O}_7 + 4\text{NaCl} + 6\text{H}_2\text{SO}_4 \longrightarrow 2\text{KHSO}_4 + 4\text{NaHSO}_4 + \underset{\begin{array}{c} \text{Chromyl chloride} \end{array}}{\text{2CrO}_2\text{Cl}_2}\uparrow + 3\text{H}_2\text{O}$$
...
$$\text{CrO}_2\text{Cl}_2 + 4\text{NaOH} \longrightarrow \text{Na}_2\text{CrO}_4 + 2\text{NaCl} + 2\text{H}_2\text{O}$$$$\text{Na}_2\text{CrO}_4 + (\text{CH}_3\text{COO})_2\text{Pb} \longrightarrow \underset{\begin{array}{c} \text{\textit{Lead chromate}} \\ \text{\textit{(Yellow precipitate)}} \end{array}}{\text{PbCrO}_4}\downarrow + 2\text{CH}_3\text{COONa}$$
...
$$2\text{MnO}_2 + 4\text{KOH} + \text{O}_2 \longrightarrow 2\underset{\begin{array}{c} \text{\textit{potassium manganate}} \\ \text{\textit{(Green)}} \end{array}}{\text{K}_2\text{MnO}_4} + 2\text{H}_2\text{O}$$
...
$$2\underset{\begin{array}{c} \text{\textit{Green}} \end{array}}{\text{MnO}_4^{2-}} \rightleftharpoons 2\underset{\begin{array}{c} \text{\textit{purple}} \end{array}}{\text{MnO}_4^-} + 2\text{e}^-$$
...
![Figure 4.9  Structure of permanganate ion](image-12.png)
...
$$2\text{KMnO}_4 + 2\underset{\begin{array}{c} \text{(cold)} \end{array}}{\text{H}_2\text{SO}_4} \longrightarrow \text{Mn}_2\text{O}_7 + 2\text{KHSO}_4 + \text{H}_2\text{O}$$
...
$$4\text{KMnO}_4 + 6\underset{\begin{array}{c} \text{(hot)} \end{array}}{\text{H}_2\text{SO}_4} \longrightarrow 4\text{MnSO}_4 + 2\text{K}_2\text{SO}_4 + 6\text{H}_2\text{O} + 5\text{O}_2$$
...
![Figure 4.10  position of inner transition elements](image-13.png)
...
![Figure 4.11 Variation of atomic radii of lanthanoids](image-14.png)
...
| 4 | Most of the lanthanoids are colourless | Most of the actinoids are coloured. For example.<br>\(U^{3+}\) (red), \(U^{4+}\) (green), \(UO_2^{2+}\) (yellow) |
...
- d- Block elements composed of 3d series (4th period) Scandium to Zinc (10 elements), 4d series (\(5^{\mathrm{th}}\) period) Yttrium to Cadmium (10 elements) and 5d series (\(6^{\mathrm{th}}\) period) Lanthanum, Haffnium to mercury.
