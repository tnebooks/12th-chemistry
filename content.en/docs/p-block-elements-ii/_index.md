...
![**Sir William Ramsay,**  **(1852 – 1916)**  ](Ram.png)
...
$$\frac{1}{2}\text{N}_2 + \frac{3}{2}\text{H}_2 \rightleftharpoons \text{NH}_3 \quad \Delta H_f = -46.2\text{ kJ mol}^{-1}$$
...
$$3\underset{\text{Nitrous acid}}{\text{HNO}_2} \longrightarrow \underset{\text{Nitric acid}}{\text{HNO}_3} + 2\underset{\text{Nitric oxide}}{\text{NO}} + \text{H}_2\text{O}$$

$$2\underset{\text{Nitrous acid}}{\text{HNO}_2} \longrightarrow \underset{\text{Dinitrogentrioxide}}{\text{N}_2\text{O}_3} + \text{H}_2\text{O}$$

$$\underset{\text{Hypo nitrous acid}}{\text{H}_2\text{N}_2\text{O}_2} \longrightarrow \underset{\text{Nitrous oxide}}{\text{N}_2\text{O}} + \text{H}_2\text{O}$$
...
| --- | --- | --- | --- | --- |
| Nitrous oxide | $\text{N}_2\text{O}$ | **+1** | Colourless gas & neutral | $\text{NH}_4\text{NO}_3 \rightarrow \text{N}_2\text{O} + 2\text{H}_2\text{O}$ |
| Nitric oxide | **NO** | **+2** | Colourless gas & neutral | $2\text{NaNO}_2 + 2\text{FeSO}_4 + 3\text{H}_2\text{SO}_4 \rightarrow \text{Fe}_2(\text{SO}_4)_3 + 2\text{NaHSO}_4 + 2\text{H}_2\text{O} + 2\text{NO}$ |
| Dinitrogen trioxide (or) Nitrogen sesquoxide | $\textbf{N}_2\textbf{O}_3$ | **+3** | Blue solid & acidic | $2\text{NO} + \text{N}_2\text{O}_4 \rightarrow 2\text{N}_2\text{O}_3$ |
| Nitrogen dioxide | $\textbf{NO}_2$ | **+4** | Brown gas & acidic | $2\text{Pb(NO}_3)_2 \rightarrow 4\text{NO}_2 + 2\text{PbO} + \text{O}_2$ |
...
![**Figure 3.2 Structure of white phosphorus**](14.png)
...
![**Figure 3.3 Structure of red phosphorus**](15.png)
...
$$\text{PH}_3 + \text{HI} \longrightarrow \text{PH}_4\text{I}$$

$$\text{PH}_4\text{I} + \text{H}_2\text{O} \xrightarrow{\quad\Delta\quad} \underset{\text{Phosphine}}{\text{PH}_3} + \text{H}_3\text{O}^+ + \text{I}^-$$
...
![**Figure 3.4 Structure of phosphine**](16.png)
...
When \( \mathrm{PCl_3} \) is treated with excess chlorine, phosphorus pentachloride is obtained.

![**Figure 3.5 Structureof phosphorus trichloride**](17.png)
...
| Name | Formula | Structure |
| --- | --- | --- |
| Hypophosphorous acid | $\text{H}_3\text{PO}_2$ | $$\begin{array}{c} \text{H} \\ \vert{} \\ \text{H}-\text{P}-\text{OH} \\ \vert{}\vert{} \\ \text{O} \end{array}$$ |
| Orthophosphrous acid | $\text{H}_3\text{PO}_3$ | $$\begin{array}{c} \text{O} \\ \vert{}\vert{} \\ \text{HO}-\text{P}-\text{OH} \\ \vert{} \\ \text{H} \end{array}$$ |
| Hypophosphoric acid | $\text{H}_4\text{P}_2\text{O}_6$ |$$\begin{array}{ccc} \text{O} & & \text{O} \\ \vert{}\vert{} & & \vert{}\vert{} \\ \text{HO}-\text{P} & - & \text{P}-\text{OH} \\ \vert{} & & \vert{} \\ \text{HO} & & \text{OH} \end{array}$$ |
| Orthophosphoric acid | $\text{H}_3\text{PO}_4$ | $$\begin{array}{c} \text{O} \\ \vert{}\vert{} \\ \text{HO}-\text{P}-\text{OH} \\ \vert{} \\ \text{OH} \end{array}$$ |
| Pyrophosphoric acid | $\text{H}_4\text{P}_2\text{O}_7$ | $$\begin{array}{ccccc} \text{O} & & & & \text{O} \\ \vert{}\vert{} & & & & \vert{}\vert{} \\ \text{HO}-\text{P} & - & \text{O} & - & \text{P}-\text{OH} \\ \vert{} & & & & \vert{} \\ \text{HO} & & & & \text{OH} \end{array}$$ |
...
| Isotopes | $^{16}\text{O}$ | $^{32}\text{S}$ | $^{80}\text{Se}$ | $^{130}\text{Te}$ | $^{209}\text{Po}$, $^{210}\text{Po}$ |
| Atomic Mass ($\text{g}\cdot\text{mol}^{-1}$ at 293 K) | 15.99 | 32.06 | 78.97 | 127.60 | 209 |
| Electronic configuration | $[\text{He}]2\text{s}^2 2\text{p}^4$ | $[\text{Ne}]3\text{s}^2 3\text{p}^4$ | $[\text{Ar}]3\text{d}^{10} 4\text{s}^2 4\text{p}^4$ | $[\text{Kr}]4\text{d}^{10} 5\text{s}^2 5\text{p}^4$ | $[\text{Xe}] 4\text{f}^{14} 5\text{d}^{10} 6\text{s}^2 6\text{p}^4$ |
| Atomic radius ($\text{\AA}$) | 1.52 | 1.80 | 1.90 | 2.06 | 1.97 |
| Density ($\text{g}\cdot\text{cm}^{-3}$ at 293 K) | $1.3 \times 10^{-3}$ | 2.07 | 4.81 | 6.23 | 9.20 |
...
![**Figure 3.8 Structure of ozone**](20.png)
...
It also reduces potassium permanganate and dichromate to Mn<sup>2+</sup> and Cr<sup>3+</sup> respectively.
...
![**Figure 3.9 Structure of sulphur dioxide**](21.png)
...
| --- | --- | --- | --- | --- | --- | --- |
| $\text{I}$ | - | - | $\text{I}_2\text{O}_5$ | - | - | $\begin{array}{c} \text{I}_4\text{O}_9 \\ \text{I}_2\text{O}_4\text{ (+4)} \end{array}$ |
...
| Type | HOX | $\text{HXO}_2$ | $\text{HXO}_3$ | $\text{HXO}_4$ |
| --- | --- | --- | --- | --- |
| |X = Cl, Br and I|  |  |
| **Common Name** | Hypohalous acid | Halous acid | Halic acid | Perhalic acid |
| **Oxidation state** | +1 | +3 | +5 | +7 |
| **F** | HOF | - | - | - |
| **Cl** | HOCl | $\text{HClO}_2$ | $\text{HClO}_3$ | $\text{HClO}_4$ |
| **Br** | HOBr |  | $\text{HBrO}_3$ | $\text{HBrO}_4$ |
| **I** | HOI |  | $\text{HIO}_3$ | $\text{HIO}_4$ |
...
| Isotopes | $^{20}\text{Ne}$ | $^{40}\text{Ar}$ | $^{84}\text{Kr}$ | $^{132}\text{Xe}$ | $^{211}\text{Rn}$, $^{220}\text{Rn}$, $^{222}\text{Rn}$ |
| Atomic Mass ($\text{g}\cdot\text{mol}^{-1}$ at 293 K) | 20.18 | 39.95 | 77.92 | 131.29 | [222] |
| Electronic configuration | $[\text{He}]2\text{s}^2 2\text{p}^6$ | $[\text{Ne}]3\text{s}^2 3\text{p}^6$ | $[\text{Ar}]3\text{d}^{10} 4\text{s}^2 4\text{p}^6$ | $[\text{Kr}]4\text{d}^{10} 5\text{s}^2 5\text{p}^6$ | $[\text{Xe}] 4\text{f}^{14} 5\text{d}^{10} 6\text{s}^2 6\text{p}^6$ |
| Atomic radius ($\text{\AA}$) | 1.54 | 1.88 | 2.02 | 2.16 | 2.20 |
| Density ($\text{g}\cdot\text{cm}^{-3}$ at 293 K) | $8.25 \times 10^{-4}$ | $1.63 \times 10^{-3}$ | $3.42 \times 10^{-3}$ | $5.37 \times 10^{-3}$ | $9.07 \times 10^{-3}$ |
