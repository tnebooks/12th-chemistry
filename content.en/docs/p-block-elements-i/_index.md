...
Note: The trialkyl borate on reaction with sodium hydride in tetrahydrouran to form a coordination compound \(Na[B(H(OR)_3]\), which acts as a powerful reducing agent.
...
The name alum is given to the double salt of potassium aluminium sulphate \([K_2SO_4.Al_2(SO_4)_3,24H_2O]\). Now a days it is used for all the double salts with \(M_2^ISO_4 \cdot M_2^{III}(SO_4)_3,24H_2O\), where \(M^I\) is univalent metal ion or \([NH_4]^+\) and \(M^{III}\) is trivalent metal ion.
