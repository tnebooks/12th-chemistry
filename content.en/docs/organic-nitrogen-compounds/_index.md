...
|---|---|
| \( \mathrm{CH_3CH(CH_3)CH_2NO_2} \) <br>2-Methyl-1-nitropropane | 2-Methyl-1-nitropropane |
| \( \mathrm{(CH_3)_3C-CH_2-NO_2} \) <br>2,2-dimethyl-1-nitropropane | 2,2-dimethyl-1-nitropropane |
| Nitrobenzene \( \mathrm{C_6H_5NO_2} \) | nitrobenzene |
| \( \mathrm{CH_3-C_6H_4-NO_2} \) (o-) <br>2-nitro-1-methylbenzene | 2-nitro-1-methylbenzene |
| 1,3,5-trinitrobenzene | 1,3,5-trinitrobenzene |
| \( \mathrm{C_6H_5-CH_2-CH_2-NO_2} \) <br>2-phenyl-1-nitroethane | 2-phenyl-1-nitroethane |
...
|---|---|
| Chain isomerism: <br>They differ in the length of carbon chain. | \( \mathrm{CH_3CH_2CH_2CH_2-NO_2} \) and \( \mathrm{CH_3CH(CH_3)CH_2-NO_2} \) <br>1-nitrobutane & 2-methyl-1-nitropropane |
| Position isomerism: <br>They differ in the position of nitro group. | \( \mathrm{CH_3CH_2CH_2CH_2-NO_2} \) and \( \mathrm{CH_3CH_2CH(NO_2)CH_3} \) <br>1-nitrobutane & 2-nitrobutane |
| Functional isomerism: <br>Nitroalkanes exhibit functional isomerism with alkyl nitrites | \( \mathrm{CH_3CH_2CH_2CH_2-NO_2} \) and \( \mathrm{CH_3CH_2CH_2CH_2-O-N=O} \) <br>1-nitrobutane & butyl nitrite |
...
| Compound (common name, Structural formula, IUPAC Name) | IUPAC Name |
|---|---|
| Isopropylamine <br> \( \mathrm{(CH_3)_2CH-NH_2} \) | Propan-2-amine |
| Allylamine <br> \( \mathrm{CH_2=CH-CH_2-NH_2} \) | Prop-2-en-1-amine |
| Hexamethylene diamine <br> \( \mathrm{H_2N-(CH_2)_6-NH_2} \) | Hexane-1,6-diamine |
| Methyl isopropyl amine <br> \( \mathrm{CH_3-NH-CH(CH_3)_2} \) | N-methylpropan-2-amine |
| Diethyl butylamine <br> \( \mathrm{(C_2H_5)_2N-CH_2CH_2CH_2CH_3} \) | N,N-Diethylbutan-1-amine |
| Ethyl methyl isopropylamine <br> \( \mathrm{CH_3-N(C_2H_5)-CH(CH_3)_2} \) | N-ethyl-N-methylpropan-2-amine |
| N,N-Dimethyl aniline <br> \( \mathrm{C_6H_5-N(CH_3)_2} \) | N,N-Dimethylbenzenamine |
| Benzylamine <br> \( \mathrm{C_6H_5CH_2NH_2} \) | Phenylmethanamine |
| N-methyl benzylamine <br> \( \mathrm{C_6H_5CH_2NHCH_3} \) | N-methyl phenylmethanamine |
...
\[
\mathrm{R-CONH_2 \xrightarrow{LiAlH_4 \atop ii)\ H_2O} R-CH_2-NH_2}
\]
...
\[
\mathrm{C_6H_5Cl + NH_3 \xrightarrow{Cu_2O \atop 200^{\circ}C} C_6H_5NH_2}
\]
...
\[
\mathrm{C_2H_5OH + NH_3 \xrightarrow{Al_2O_3, -H_2O} C_2H_5NH_2 \xrightarrow{C_2H_5OH \atop -H_2O} (C_2H_5)_2NH \xrightarrow{C_2H_5OH \atop -H_2O} (C_2H_5)_3N}
\]

b) Phenol reacts with ammonia at \( 300^{\circ}C \) in the presence of anhydrous \( \mathrm{ZnCl_2} \) to give aniline.

\[
\mathrm{C_6H_5OH + NH_3 \xrightarrow{anhyd.\ ZnCl_2 \atop 300^{\circ}C} C_6H_5NH_2 + H_2O}
\]
...
ii) When aniline is treated with carbon disulphide, S-diphenylthiourea is formed, which on boiling with strong HCl, phenyl isothiocyanate (phenyl mustard oil), is formed.
...
\[
\mathrm{C_6H_5N_2^+Cl^- \xrightarrow{SnCl_2+HCl \atop (or)\ Na_2SO_3} C_6H_5NHNH_2}
\]
...
\[
\mathrm{C_6H_5N_2^+Cl^- + C_6H_5OH \xrightarrow{pH\ (9-10) \atop 273-278K} C_6H_5-N=N-C_6H_4-OH\ (p-hydroxy\ azobenzene)}
\]

\[
\mathrm{C_6H_5N_2^+Cl^- + C_6H_5NH_2 \xrightarrow{pH\ (4-5) \atop 273-278K} C_6H_5-N=N-C_6H_4-NH_2\ (p-amino\ azobenzene)}
\]
...
| Compound (common name, Structural formula, IUPAC Name) | IUPAC Name |
|---|---|
| Acetonitrile \( \mathrm{CH_3-CN} \) | Ethanenitrile |
| Propiononitrile \( \mathrm{CH_3CH_2-CN} \) | Propanenitrile |
| Butyronitrile \( \mathrm{CH_3CH_2CH_2-CN} \) | Butanenitrile |
| Isobutyronitrile \( \mathrm{(CH_3)_2CH-CN} \) | 2-methylpropanenitrile |
| Benzonitrile \( \mathrm{C_6H_5-CN} \) | Benzenecarbonitrile |
| 3-Cyanobutanoicacid \( \mathrm{CH_3CH(CN)CH_2COOH} \) | 3-Cyanobutanoicacid |
| 2-Bromo-3-chloro-3-methyl pentanenitrile | 2-Bromo-3-chloro-3-methylpentanenitrile |

#### 13.4.2 Methods of preparation of cyanides

**1) From alkyl halides**

When alkyl halides are treated with a solution of NaCN (or) KCN, alkyl cyanides are obtained. In this reaction a new carbon-carbon bond is formed.
...
Aryl cyanide cannot be prepared in this method because of their less reactivity towards nucleophilic substitution. Aryl cyanides are prepared using Sandmeyer reactions.

**2. By dehydration of primary amides and aldoximes with \( \mathrm{P_2O_5} \)**
...
**3. By dehydration of ammonium carboxylates with \( \mathrm{P_2O_5} \)**

\[
\mathrm{CH_3COONH_4 \xrightarrow[\Delta]{P_2O_5} CH_3CN + 2H_2O}
\]

This method is suitable for large scale preparation of alkyl cyanides.
...
**1) Hydrolysis:** Alkyl isocyanides are not hydrolysed by alkalies. However they are hydrolysed with dilute mineral acids to give primary amines and formic acid.
...
\[
\mathrm{CH_3-NC + 4[H] \xrightarrow{Na/C_2H_5OH \atop (or)\ Ni/H_2} CH_3-NH-CH_3}
\]

**3) Isomerisation:** When Alkyl isocyanides are heated at \( 250^{\circ}C \), they change into the more stable, isomeric cyanides.
