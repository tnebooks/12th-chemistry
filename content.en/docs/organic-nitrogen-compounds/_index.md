...
references:
    videos:
      ...
      - custom:
          title: "Acidic Nature Of Nitro Alkanes"
          desc: "Acidic Nature Of Nitro Alkanes"
          url: "https://d1fiv8ydi7ukjo.cloudfront.net/manarkeni/video/973cb65a-5433-4ede-a537-d37201073bf3.mp4"
      - custom:
          title: "By Direct Nitration"
          desc: "By Direct Nitration"
          url: "https://d1fiv8ydi7ukjo.cloudfront.net/manarkeni/video/b8aa29eb-1810-4247-ba76-e5c24fb3b9ad.mp4"
      - custom:
          title: "Electrophilic Substitution Reaction"
          desc: "Electrophilic Substitution Reaction"
...
$$\underset{\text{Ethane}}{\text{CH}_3\text{-CH}_3} + \text{HNO}_3 \xrightarrow{675\text{ K}} \underset{\text{Nitroethane}(73\%)}{\text{CH}_3\text{CH}_2\text{-NO}_2} + \underset{\text{Nitromethane (27\%)}}{\text{CH}_3\text{NO}_2}$$
...
&\underset{\text{\vphantom{Ethanol}}}{\text{Ethylnitrite}}\underset{\text{Ethanol}}{\text{}}
\end{aligned}$$
...
**2. By dehydration of primary amides and aldoximes with \(P_2O_5\)**

![](image-23.png)

**3. By dehydration of ammonium carboxylates with \(P_2O_5\)**
...
![](img13.72.png)
b) The nitriles containing \( \alpha \)-hydrogen also undergo condensation with esters in the presence of sodamide in ether to form ketonitriles.This reaction is known as "Levine and Hauser" acetylation. 

This reaction involves replacement of ethoxy \( \mathrm{(OC_2H_5)} \) group by methylnitrile (-CH\(_2\)CN) group and is called as cyanomethylation reaction.
![](img13.73.png)
...
3. **Isomerisation:** When Alkyl isocyanides and heated at 250°C, they change into the more stable, isomeric cyanides
![](image-28.png)
