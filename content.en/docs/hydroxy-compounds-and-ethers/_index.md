...
**a) Lucas test:**
 ...
 When alcohols are treated with Lucas agent (a mixture of concentrated HCl and anhydrous \( \mathrm{ZnCl_2} \)) at room temperature, tertiary alcohols react immediately to form a turbidity due to the formation of alkyl chloride which is insoluble in the medium. Secondary alcohols react within 10 minutes to form a turbidity of alkyl chloride where primary alcohols do not react at room temperature.
![](img11.10.png)
...
When glycerol is heated with dehydrating agents such as con \( \mathrm{H_2SO_4} \), \( \mathrm{KHSO_4} \) etc..., it undergoes dehydration to form acrolein.
![](img11.32.png)
**Oxidation**
...
**a) From halo arenes (Dow's process)**
...
Phenol on heating with ammonia in presence of anhydrous \( \mathrm{ZnCl_2} \) gives aniline.
![](img11.42.png)
...
Phenol undergoes oxidation with air or acidified $\text{K}_2\text{Cr}_2\text{O}_7$ with conc. $\text{H}_2\text{SO}_4$ to form 1,4-benzoquinone.
![](image.png)
