...
$$6\text{CH}_3-\text{CH}=\text{CH}_2 + \text{B}_2\text{H}_6 \longrightarrow \begin{matrix} 2(\text{CH}_3-\text{CH}_2-\text{CH}_2)_3\text{B} \\ \text{Tripropylborane} \end{matrix}$$

$$(\text{CH}_3-\text{CH}_2-\text{CH}_2)_3\text{B} + 3\text{H}_2\text{O}_2 \xrightarrow{\quad\text{OH}^-\quad} \begin{matrix} 3\text{CH}_3-\text{CH}_2-\text{CH}_2-\text{OH} + \text{B(OH)}_3 \\ \text{propan-1-ol} \end{matrix}$$
...
$$\begin{matrix} \text{CH}_3-\text{OH} \\ \text{Methanol} \end{matrix} + \begin{matrix} \text{SOCl}_2 \\ \text{Thionyl} \\ \text{chloride} \end{matrix} \xrightarrow{\quad\text{Pyridine}\quad} \begin{matrix} \text{CH}_3-\text{Cl} \\ \text{chloromethane} \end{matrix} + \text{HCl} + \text{SO}_2$$

This reaction also follows the \( \mathrm{S_Ni} \) mechanism in the presence of pyridine.
...
$$\text{CH}_3-\text{CH}_2-\text{OH} \xrightarrow[443\text{ K}]{\quad\text{H}_2\text{SO}_4\quad} \text{CH}_2=\text{CH}_2 + \text{H}_2\text{O}$$
...
$$\begin{matrix} \text{CH}_3\text{CH}_2\text{OH} \\ \text{ethanol} \end{matrix} + \text{NAD}^+ \xrightarrow{\quad\text{ADH}\quad} \begin{matrix} \text{CH}_3\text{CHO} \\ \text{ethanal} \end{matrix} + \text{NADH} + \text{H}^+$$
...
$$\text{C}_6\text{H}_5-\text{OH} + \text{H}\cdot\text{OH} \rightleftharpoons \text{C}_6\text{H}_5-\text{O}^\ominus + \text{H}_3\text{O}^\oplus$$
...
**d) Oxidation:** Phenol undergoes oxidation with air or acidified $\text{K}_2\text{Cr}_2\text{O}_7$ with conc. $\text{H}_2\text{SO}_4$ to form 1,4-benzoquinone.
![](image.png)
...
Ethers are a class of organic compound in which an oxygen atom is connected to two alkyl/aryl groups $$(\text{R}-\ddot{\text{O}}-\text{R})$$. Ethers can be considered as the derivatives of hydrocarbon in which one hydrogen atom is replaced by an alkoxy (-OR) or an aryloxy (-OAr) group. The general formula of aliphatic ether is \( \mathrm{C_nH_{2n+2}O} \).
...
When an alkyl halide is heated with an alcoholic solution of sodium alkoxide, the corresponding ethers are obtained. The reaction involves \( \mathrm{SN^2} \) mechanism.
...
$$\text{CH}_3-\text{O}^-\text{Na}^+ + \text{CH}_3-\text{CH}_2-\text{Br} \xrightarrow[\Delta]{\quad-\text{NaBr}\quad} \begin{matrix} \text{CH}_3-\text{CH}_2-\ddot{\text{O}}-\text{CH}_3 \\ \text{methoxyethane} \end{matrix}$$
...
$$\begin{matrix} \text{CH}_3-\text{O}-\text{CH}_2-\text{CH}_3 \\ \text{methoxy ethane} \end{matrix} + \text{HI} \xrightarrow{\quad\Delta\quad} \begin{matrix} \text{CH}_3\text{I} \\ \text{iodo methane} \end{matrix} + \begin{matrix} \text{CH}_3-\text{CH}_2-\text{OH} \\ \text{ethanol} \end{matrix}$$
$$\begin{matrix} \text{C}_6\text{H}_5-\text{O}-\text{CH}_3 \\ \text{methoxy benzene} \end{matrix} + \text{HI} \longrightarrow \begin{matrix} \text{C}_6\text{H}_5-\text{OH} \\ \text{Phenol} \end{matrix} + \begin{matrix} \text{CH}_3\text{I} \\ \text{iodomethane} \end{matrix}$$

**Mechanism:** Ethers having primary alkyl group undergo \( \mathrm{SN^2} \) reaction while tertiary alkyl ether undergo \( \mathrm{SN^1} \) reaction. Protonation of ether is followed by the attack of halide ion. The halide ion preferentially attacks the less sterically hindered of the two alkyl groups which are attached to etherial oxygen.
![](img11.66.png)
When excess HBr or HI is used, the alcohol formed will further react with HBr or HI to form alkyl halides.

$$\begin{matrix} \text{CH}_3-\text{CH}_2-\text{OH} \\ \text{ethanol} \end{matrix} \xrightarrow{\quad\text{excess HBr}\quad} \begin{matrix} \text{CH}_3-\text{CH}_2-\text{Br} \\ \text{bromoethane} \end{matrix}$$
