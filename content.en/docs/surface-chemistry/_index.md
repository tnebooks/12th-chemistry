...
| 8. Adsorption occurs at fixed sites called active centres. | 8. It occurs on all sides. It depends on surface area |
...
$$
\text{vegetable oil} + H_2 \xrightarrow{Ni \text{ catalyst}} \text{vanaspathi}
$$
...
\begin{array}{rl}
& A + B \rightarrow AB \\
& A + C \rightarrow AC \quad (\text{intermediate}) \quad (\text{C is the catalyst}) \\
...
Enzymes involved in human body have an optimum temperature \(37^{\circ}C / 98^{\circ}F\). During high fever, as body temperature rises the enzymatic activity may collapse and lead to danger.
...
$$
\text{NaCN} + R_4N^+Cl^- \rightarrow R_4N^+CN^- + NaCl \quad \text{(aqueous phase)}
$$

$$
R_4N^+CN^- + R-Cl \rightarrow R-CN \quad \text{(organic phase)}
$$
...
$$
AgCl \xrightarrow{HCl} AgCl \ \text{(colloidal)}
$$
