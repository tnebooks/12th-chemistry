...
The concentration of the reactant (\( [A] \)) can be measured at different time intervals. Let the concentration of A at two different times \( t_1 \) and \( t_2 \), (\( t_2> t_1 \)) be \( [A_1] \) and \( [A_2] \) respectively. The rate of the reaction can be expressed as
...
$$\text{i.e., Rate} = \frac{-([A_2]-[A_1])}{(t_2-t_1)} = -\left(\frac{\Delta[A]}{\Delta t}\right) \text{ ...(7.1)}$$
...
\[
\text{The rate over the entire 30 min} = \frac{-(0.69 - 2)\ \mathrm{mol\ L^{-1}}}{(30 - 0)\ \mathrm{min}}
\]
...
$$= \frac{0.6}{10} = 6 \times 10^{-2} \text{ mol L}^{-1} \text{ min}^{-1}$$

$$(\text{Rate})_{\text{later stage}} = \frac{-(0.69-0.98)}{(30-20)}$$

$$= \frac{0.29}{10} = 2.9 \times 10^{-2} \text{ mol L}^{-1} \text{ min}^{-1}$$
...
| Rate mol L\(^{-1}\) min\(^{-1}\) | [cyclopropane] mol L\(^{-1}\) | \( k = \frac{\text{Rate}}{[\text{cyclopropane}]} \) |
|---|---|---|
...
$$\ln \left( \frac{\text{k}_2}{\text{k}_1} \right) = \frac{\text{E}_\text{a}}{\text{R}} \left( \frac{1}{\text{T}_1} - \frac{1}{\text{T}_2} \right)$$

$$2.303 \log \left( \frac{\text{k}_2}{\text{k}_1} \right) = \frac{\text{E}_\text{a}}{\text{R}} \left( \frac{\text{T}_2 - \text{T}_1}{\text{T}_1 \text{T}_2} \right)$$

$$\log \left( \frac{\text{k}_2}{\text{k}_1} \right) = \frac{\text{E}_\text{a}}{2.303\text{R}} \left( \frac{\text{T}_2 - \text{T}_1}{\text{T}_1 \text{T}_2} \right)$$
...
$$\text{T}_2 = 400\text{K} \quad ; \quad \text{k}_2 = 0.04 \text{ s}^{-1}$$

$$\text{T}_1 = 200\text{K} \quad ; \quad \text{k}_1 = 0.02 \text{ s}^{-1}$$

$$\log\left(\frac{0.04 \text{ s}^{-1}}{0.02 \text{ s}^{-1}}\right) = \frac{\text{E}_\text{a}}{2.303 \times 8.314 \text{ JK}^{-1}\text{mol}^{-1}}\left(\frac{400\text{K} - 200\text{K}}{200\text{K} \times 400\text{K}}\right)$$



$$\log(2) = \frac{\text{E}_\text{a}}{2.303 \times 8.314 \text{ JK}^{-1}\text{mol}^{-1}}\left(\frac{1}{400\text{K}}\right)$$

$$\text{E}_\text{a} = \log(2) \times 2.303 \times 8.314 \text{ JK}^{-1}\text{mol}^{-1} \times 400\text{K}$$

$$\text{E}_\text{a} = 2305 \text{ J mol}^{-1}$$
...
$$\log \text{k} = \log \text{A} - \frac{\text{E}_\text{a}}{2.303\text{R}}\left(\frac{1}{\text{T}}\right)$$

$$\text{y} = \text{c} + \text{mx}$$

$$\text{m} = -\frac{\text{E}_\text{a}}{2.303\text{R}}$$

$$\text{E}_\text{a} = -2.303 \text{ R } m$$

$$\text{E}_\text{a} = -2.303 \times 8.314 \text{ J K}^{-1} \text{mol}^{-1} \times (-4000K)$$

$$\text{E}_\text{a} = 76,589 \text{J mol}^{-1}$$

$$\text{E}_\text{a} = 76.589 \text{ kJ mol}^{-1}$$
...
>| C | 40 | 10 | 0.08 | |
>
>Draw a graph between \( \frac{1}{t} \) Vs concentration of sodium thiosulphate. A graph like the following one is obtained.\( \frac{1}{t} \) is a direct measure of rate of reaction and therefore, the increase in the concentration of reactants i.e \( \mathrm{Na}_2\mathrm{S}_2\mathrm{O}_3 \) increases the rate.
>
>![](acti.png)
>
>![](glass.png)
...
>
>Since, carbon dioxide escapes during reaction, the mass of the flask gets lighter as the reaction proceeds. So, by measuring the loss in mass of the flask, we can follow the rate of the reaction. A plot of loss in mass Vs time is drawn and it looks like the one as shown below.
>
