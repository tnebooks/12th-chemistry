...
**(1) Mechanical Dispersion:** Using a colloid mill, the solid is ground to colloidal dimension. The colloid mill consists of two metal plates rotating in opposite direction at very high speed of nearly 7000 revolution / minute.
...
![Bredigs are method](Bredig's-are-method.jpg)
...
**(3) Hydrolysis** Sols of hydroxides of metals like chromium and aluminium can be produced by this method. **For Example,**
...
S<sub>2</sub>O<sub>3</sub><sup>2-</sup>+2H<sup>+</sup> → S+H<sub>2</sub>O+SO<sub>2</sub>
...
When the colloidal solution is dilute, it is stable. When the volume of medium is decreased
...
**9) Shape of colloidal particles** It is very interesting to know the various shapes of colloidal particles. Here are some examples
...
![Brownian movement](BrownianMovemont.jpg)
...
![Electrophoresis](Electophoresis.jpg)
...
![Electro osmosis](Elecro-osmosis.jpg)
