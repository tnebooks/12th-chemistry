...
\(^{+5}\) HNO\(_3\)    \(^{+4}\) NO\(_2\)    \(^{+3}\) HNO\(_2\)    \(^{+2}\) NO    \(^{+1}\) N\(_2\)O    \(^{0}\) N\(_2\)    \(^{-3}\) NH\(_3\)
...
| டை நைட்ரஜன் ட்ரை ஆக்சைடு (அ) நைட்ரஜன் செஸ்கியூஆக்சைடு | \( N_2O_3 \) | +3 | நீலநிறத் திண்மம் & அமிலத் தன்மை கொண்டது | \( 2NO + N_2O_4 \rightarrow 2N_2O_3 \) |
| நைட்ரஜன் டை ஆக்சைடு | \( NO_2 \) | +4 | பழுப்புநிற வாயு & அமிலத் தன்மை கொண்டது | \( 2Pb(NO_3)_2 \rightarrow 4NO_2 + 2PbO + O_2 \) |
| நைட்ரஜன் டெட்ராக்சைடு | \( N_2O_4 \) | +4 | நிறமற்ற திண்மம் & அமிலத் தன்மை கொண்டது | \( 2NO_2 \rightarrow N_2O_4 \) |
...
$$4\text{HCl} + \text{O}_2 \xrightarrow[\text{Cu}_2\text{Cl}_2]{400^\circ\text{C}} 2\text{H}_2\text{O} + 2\text{Cl}_2 \uparrow$$
...
**ஹைட்ரஜன் மீதான நாட்டம்:**  டர்பென்டைனுடன் சேர்த்து எரிக்கும் போது கார்பன் மற்றும் ஹைட்ரோ குளோரிக் அமிலத்தைத் தருகிறது.
...
$$ \text{H}_2\text{O} + \text{Cl}_2 \longrightarrow \text{HCl} + \underset{(\text{ஹைப்போ குளோரஸ் அமிலம்})}{\text{HOCl}} $$

$$ \text{HOCl} \longrightarrow \text{HCl} + (\text{O}) $$

நிறமுள்ள பொருள் + பிறவிநிலை ஆக்சிஜன் → நிறமற்ற விளைப்பொருள்

குளோரினின் வெளுக்கும் பண்பு நிலையானது. இது பெர்ரஸ் உப்புகளை பெரிக் உப்புகளாகவும் சல்பைடுகளை சல்பேடுகளாகவும் மேலும் ஹைட்ரஜன் சல்பைடை கந்தகமாகவும் ஆக்சிஜனேற்றம் அடையச் செய்கிறது.
...
**சலவைத் தூள் தயாரித்தல்:** குளோரின் வாயுவை உலர்ந்த கால்சியம் ஹைட்ராக்சைடு கரைசலின் வழியாக செலுத்தும் போது சலவைத் தூள் உருவாகிறது.
...
$$ \text{SO}_2 + \text{Cl}_2 \longrightarrow \underset{(\text{சல்பரைல் குளோரைடு})}{\text{SO}_2\text{Cl}_2} $$

$$ \text{CO} + \text{Cl}_2 \longrightarrow \underset{(\text{கார்பனைல் குளோரைடு})}{\text{COCl}_2} $$

$$ \text{C}_2\text{H}_4 + \text{Cl}_2 \longrightarrow \underset{(\text{எத்திலின் டைகுளோரைடு})}{\text{C}_2\text{H}_4\text{Cl}_2} $$
...
$$ \text{Na}_2\text{CO}_3 + 2\text{HCl} \longrightarrow 2\text{NaCl} + \text{CO}_2 + \text{H}_2\text{O} $$

$$ \text{CaCO}_3 + 2\text{HCl} \longrightarrow \text{CaCl}_2 + \text{CO}_2 + \text{H}_2\text{O} $$

$$ \text{NaHCO}_3 + 2\text{HCl} \longrightarrow 2\text{NaCl} + \text{CO}_2 + \text{H}_2\text{O} $$

சோடியம் சல்பைட்டிலிருந்து கந்தக டை ஆக்சைடை வெளியேற்றுகிறது.

$$ \text{Na}_2\text{SO}_3 + 2\text{HCl} \longrightarrow 2\text{NaCl} + \text{H}_2\text{O} + \text{SO}_2 $$
...
$$ \text{Au} + 4\text{H}^+ + \text{NO}_3^- + 4\text{Cl}^- \longrightarrow \text{AuCl}_4^- + \text{NO} + 2\text{H}_2\text{O} $$

$$ 3\text{Pt} + 16\text{H}^+ + 4\text{NO}_3^- + 18\text{Cl}^- \longrightarrow 3[\text{PtCl}_6]^{2-} + 4\text{NO} + 8\text{H}_2\text{O} $$
...
**சகப்பிணைப்பு ஹைட்ரைடுகள்:** ஹேலஜன்கள் ஹைட்ரஜன் சல்பைடால் ஹைட்ரஜன் ஹேலைடுகளாக ஒடுக்கப்படுகின்றன.
...
| ஐசோடோப்புகள் | \( ^{20}Ne \) | \( ^{40}Ar \) | \( ^{84}Kr \) | \( ^{132}Xe \) | \( ^{211}Rn, ^{220}Rn, ^{222}Rn \) |
| அணு நிறை (g.mol\(^{-1}\) ல் 293 K)| 20.18 | 39.95 | 77.92 | 131.29 | [222] |
| எலக்ட்ரான் அமைப்பு | \( [He]2s^2 2p^6 \) | \( [Ne]3s^2 3p^6 \) | \( [Ar]3d^{10} 4s^2 4p^6 \) | \( [Kr]4d^{10} 5s^2 5p^6 \) | \( [Xe] 4f^{14} 5d^{10} 6s^2 6p^6 \) |
...
$$ \text{Xe} + 2\text{F}_2 \xrightarrow[400^\circ\text{C}]{\text{Ni / அசிட்டோன்}} \text{XeF}_4 $$
...
4.(A) என்ற திண்மம் நீர்த்த வலிமைமிக NaOH கரைசலுடன் வினைபுரிந்து அருவருக்கத்தக்க மணமுடைய வாயு (B)ஐத் தருகிறது. (B) யானது காற்றில் தன்னிச்சையாக எரிந்து புகை வளையங்களை உருவாக்குகிறது. (A) மற்றும் (B) முறையே
...
7.பைரோபாஸ்பரஸ் அமிலத்தின் ($\text{H}_4\text{P}_2\text{O}_5$) காரத்துவம்
...
அ) $\text{HI} > \text{HBr} > \text{HCl} > \text{HF}$

ஆ) $\text{HF} > \text{HCl} > \text{HBr} > \text{HI}$

இ) $\text{HCl} > \text{HF} > \text{HBr} > \text{HI}$

ஈ) $\text{HI} > \text{HCl} > \text{HF} > \text{HBr}$
...
8.\( IF_7^- \) இல் அயோடினின் இனக்கலப்பு யாது? அதன் வடிவமைப்பினைத் தருக.
