...
![படிகங்களின் திசையொப்பு பண்பற்றத் தன்மை | படிகவடிவமற்ற திண்மங்களின் திசையொப்பு பண்பு](image-1.png)
...
![முதல்நிலை அலகுக்கூடுகள் | முதல்நிலை அற்ற அலகுக்கூடுகள்](3.png)

![](4.png)

![படம் 6.2 பதினான்கு பிராவே அணிக்கோவை தளங்கள்](5.png)
...
மேற்கண்டுள்ள சமன்பாடு பிராக் சமன்பாடு எனப்படும். இங்கு \( \lambda \) என்பது விளிம்பு விளைவிற்குப் பயன்படுத்தப்பட்ட X கதிரின் அலைநீளம், \( \theta \) என்பது விளிம்பு விளைவுக் கோணம் மற்றும் n என்பது எதிரொளிப்பு படி ஆகும்.
...
$$\text{அலகுக்கூட்டின் அடர்த்தி }(\rho) = \frac{\text{அலகுக்கூட்டின் நிறை}}{\text{அலகுக்கூட்டின் கனஅளவு}}$$

$$\tag{1}$$

$$\text{அலகுக்கூட்டின் நிறை} = \left\{ \frac{\text{ஒரு அலகுக்கூட்டிற்கு}}{\substack{\text{உரிய அணுக்களின்}\\\text{மொத்த எண்ணிக்கை}}} \right\} \times \left\{ \frac{\text{ஒரு அணுவின்}}{\text{நிறை}} \right\}$$

$$\tag{2}$$

$$\text{ஒரு அணுவின் நிறை} = \frac{\text{மோலார் நிறை }(\text{gmol}^{-1})}{\text{அவகாட்ரோ எண் }(\text{mol}^{-1})}$$

$$\text{m} = \frac{\text{M}}{\text{N}_\text{A}}$$
...
\[
= 4 \times \frac{\sqrt{2} \pi a^3}{24} = \frac{\sqrt{2} \pi a^3}{6} \quad ...(4)
\]

சமன்பாடு (4) ஐ (1) ஆல் வகுக்க,
...
![உலோகம் அதிகமுள்ள குறைபாடு](9.png)
...
![உலோகம் குறைவுபடும் குறைபாடு](image-7.png)
