...
$f = e^{-\left( \frac{100 \times 10^3 \, \text{J mol}^{-1}}{8.314 \, \text{J K}^{-1} \, \text{mol}^{-1} \times 300 \, \text{K}} \right)}$
...
$\Rightarrow$ வினைவேகம் = $p \times f \times$ மோதல் வீதம்

$= p \ e^{\frac{-E_a}{RT}} \ Z [A_2][B_2]$ $\dots$ (1)

வேகவிதிப்படி,

வினைவேகம் = $k [A_2][B_2]$ $\dots$ (2)
