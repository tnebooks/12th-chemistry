...
![படம் 7.3 துவக்கச் செறிவு $[A]_0 = 1.00 \, M$ மற்றும் $k = 2.5 \times 10^{-2} \, \text{min}^{-1}$ ஆக உள்ள](7.3.png)
**$A \longrightarrow$ விளைபொருள் என்ற வினைக்கு $\ln[A]$ Vs $t$ வரைபடம்.**
...
![படம் 7.4 துவக்கச் செறிவு \([A_0] = 0.5 \ m\) மற்றும் வினைவேக மாறிலி \( k = 1.5 \times 10^{-2} \ mol^{-1} L^{-1} min^{-1} \) என அமையும் \( A \longrightarrow \text{வினை பொருள்} \) என்ற பூஜ்ய வகை வினைக்கான [A] Vs t வரைபடம்.](7.4.png)
