---
title: 'IUPAC பெயரிடும் முறை(IUPAC Nomenclature)'
weight: 2
---
...
படத்தில் உள்ள ஒட்டுமொத்த வேதி வினைகள் மற்றும் அவற்றின் பெயர்கள் KaTeX வடிவத்தில் கீழே கொடுக்கப்பட்டுள்ளன:



$$6\text{CH}_3-\text{CH}=\text{CH}_2 + \text{B}_2\text{H}_6 \longrightarrow 2(\text{CH}_3-\text{CH}_2-\text{CH}_2)_3\text{B}$$

$$\text{டிரைபுரப்பைல்போரேன்}$$


$$(\text{CH}_3-\text{CH}_2-\text{CH}_2)_3\text{B} + 3\text{H}_2\text{O}_2 \xrightarrow{\quad\text{OH}^-\quad} 3\text{CH}_3-\text{CH}_2-\text{CH}_2-\text{OH} + \text{B(OH)}_3$$
...
| 2 | புரப்பனல் | \( CH_3-CH_2-CHO \) | 58 | 322 |
| 3 | மீத்தாக்ஸி ஈத்தேன் | \( CH_3-O-CH_2-CH_3 \) | 60 | 283.8 |
| 4 | புரப்பன்  - 1- ஆல் | \( CH_3-CH_2-CH_2-OH \) | 60 | 370.4 |
| 5 | புரப்பன் - 2 - ஆல் | \( CH_3-CH(OH)-CH_3 \) | 60 | 355.5 |
...
$$\text{CH}_3-\text{OH} + \text{SOCl}_2 \xrightarrow{\quad\text{பிரிடின்}\quad} \text{CH}_3-\text{Cl} + \text{HCl} + \text{SO}_2$$

$$\text{மெத்தனால்} \qquad\quad \begin{matrix} \text{தயோனைல்} \\ \text{குளோரைடு} \end{matrix} \qquad\qquad\qquad\quad \text{குளோரோ மீத்தேன்}$$
...
படத்தில் உள்ள ஸ்வர்ன் ஆக்ஸிஜனேற்ற (Swern Oxidation) வேதி வினை மற்றும் அதன் பெயர்கள் KaTeX வடிவத்தில் கீழே கொடுக்கப்பட்டுள்ளன:

$$\begin{matrix} \quad\text{OH} \\ \quad| \\ \text{CH}_3-\text{CH}-\text{CH}_3 \end{matrix} + \begin{matrix} \quad\text{O} \\ \quad|| \\ \text{H}_3\text{C}-\text{S}-\text{CH}_3 \end{matrix} + \begin{matrix} \text{O} \quad \text{O} \\ || \quad || \\ \text{Cl}-\text{C}-\text{C}-\text{Cl} \end{matrix}$$

$$\text{புரப்பன் - 2 - ஆல்} \qquad\qquad\quad \text{DMSO} \qquad\qquad \text{ஆக்சலைல்குளோரைடு}$$

$$\downarrow \text{Et}_3\text{N}$$

$$\begin{matrix} \quad\text{O} \\ \quad|| \\ \text{CH}_3-\text{C}-\text{CH}_3 \end{matrix} + (\text{CH}_3)_2\text{S} + \text{CO}_2 + \text{CO} + 2\text{HCl}$$
...
**கிளைக்காலின் ஆக்சிஜனேற்றியின்**


ஆக்சிஜனேற்றியின்  தன்மை மற்றும் வினை நிகழ் நிபந்தனைகளைப் பொறுத்து ஆக்ஸிஜனேற்றத்தில் கிளைக்கால் பல்வேறு விளைபொருட்களைத் தருகிறது.
...
ஆக்சிஜனேற்றத்திற்க பயன்படுத்தப்படும் ஆக்சிஜனேற்றியைப பொருத்து கிளிசரால் வெவ்வேறு ஆக்சிஜனேற்ற வினைப்பொருட்களைத் தருகிறது.
...
இ) பிஸ்மத்நைட்ரேட் உடன் ஆக்சிஜனேற்றம செய்யும் போது ு மீசோ ஆக்சாலிக் அமிலம் உருவாகிறது.
ஈ) \( Br_2/H_2O \) அல்லது \( NaOBr \) (அல்லது)  பென்டான்  வினைப்பொருள் \( FeSO_4 + H_2O_2 \) ஆகியனவற்றுள் ஒன்றை ஆக்சிஜனேற்றியாக பயன்படுத்தும் போது கிளிசரால்டிஹைடு மற்றும் டைஹைட்ராக்ஸி அசிட்டோன் ஆகிய   விளைபொருட்களின் கலவை உருவாகிறது. இந்த கலவையின் பெயர் கிளிசரோஸ்.
...
1.  எத்தனால் பெயின்டுகள் மற்றும் வார்னிஷ் தயாரிப்பில் பயன்படுகிறது. மேலும் ஈதர், குளோரோபார்ம அயடோபார்ம், சாயங்கள், ஊடுருவும் மற்றும் சோப்புகள் ஆகியனவற்றின் தயாரிப்பில் பயன்படுகிறது.
...
$$\text{பீனால்} \qquad\qquad \text{அசிட்டைல் குளோரைடு} \qquad\qquad\quad \text{பினைல் எத்தனோயேட்}$$
...
\( -OH, -NH_2 \) போன்ற தொகுதிகள் பென்சீன் வளையத்தின் நேரடியாக இடம் பெற்றிருக்கும் போது அவை பென்சீன் வளையத்தை கிளர்வுறுத்துவதால் வரக்கூடிய எலக்ட்ரான் பொருள்கள் ஆர்த்தோ மற்றும் பாரா இடத்தை ஆக்கிரமித்துக் கொள்கின்றன என்பதை பதினொராம் வகுப்பில் படித்துள்ளோம்.
...
iii) பீனால் \( NaOH \) உடன் சோடியம் பீனாக்ஸைடைதருகிறது. ஆனால் எத்தனால் \( NaOH \) உடன் ் வினைபடுவதில்லை.
...
இரண்டு ஆல்கைல் / அரைல் தொகுதிகளை ஒரு ஆக்ஸிஜன் அணுவின் மூலம் ( \( R - O - R \) ) இணைக்கும் கரிமச் சேர்மங்களுக்கு ஈதர்கள் என்று பெயர். ஹைட்ரோ கார்பனில் உள்ள ஒரு ஹைட்ரஜன் அணுவிற்கு பதிலாக ஆல்காக்ஸி ( \( -OR \) ) அல்லது அரைலாக்ஸி தொகுதி ( \( -OAr \) ) களால் பதிலீடு செய்யப்பட்ட ஹைட்ரோ கார்பனின் பெறுதிகள் என ஈதர்கள் கருதப்படுகின்றன. அலிபாட்டிக் ஈதர்களின் பொதுவாய்பாடு \( C_nH_{2n+2}O \).
...
2.  அமில வலிமையின் அடிப்படையில் ஏறுவரிசையில் வரிசைப்படுத்துக. புரப்பேன்- 1 - ஆல், 2, 4, 6 - ட்ரைநைட்ரோ பீனால், 3 - நைட்ரோ பீனால், 3, 5 - டைநைட்ரோ பீனால், பீனால், 4- மெத்தில்பீனால்.
...
| :--- | :--- | :--- |
| \( CH_3-(CH_2)_5-CH_3 \) n-ஹெப்டேன்| 100.21 | 371K |
|\( CH_3-O-(CH_2)_4-CH_3 \) 1 – மீத்தாக்சிபென்ட்டேன்| 102.17 | 373K |
|\( CH_3-(CH_2)_5-OH \) ஹெக்சன் – 1 – ஆல்| 102.16 | 430K |
...
Here is the exact layout of the text and chemical formulas from the image, formatted with LaTeX:

$$\text{CH}_3\text{-O-CH}_2\text{-CH}_3 + \text{HI} \xrightarrow{\quad\Delta\quad} \text{CH}_3\text{I} \quad + \text{CH}_3\text{-CH}_2\text{-OH}$$

$$\text{மீத்தாக்சி ஈத்தேன்} \qquad\qquad\qquad\quad\ \ \text{அயடோ மீத்தேன்} \qquad\quad \text{எத்தனால்}$$

$$\text{C}_6\text{H}_5\text{-O-CH}_3 \quad + \text{HI} \longrightarrow \quad \text{C}_6\text{H}_5\text{-OH} + \ \text{CH}_3\text{I}$$

$$\text{மீத்தாக்சி பென்சீன்} \qquad\qquad\qquad\qquad\quad \text{பீனால்} \qquad\ \ \text{அயடோமீத்தேன்}$$
